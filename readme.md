# 🐝 Babique's HSW Generator v1.3.52 – Free browser-based STL generator for the Honeycomb Storage Wall system
...
| **Diamond** | Quarter-hex quadrilateral |
| **Eclat** | Half-diamond shape |
...
- 🗂️ **Layers** — organize pieces into color-coded groups with visibility control
- 🔍 **Selection tools** — rubber band select, multi-select with Shift, duplicate selections
...
- Built as a **single self-contained HTML file** (~6800 lines)
