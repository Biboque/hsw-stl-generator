...
### v1.3.6c (2026-04-07)
- Improved selection behavior: default click deselects all and selects single piece, Shift+click for multi-select

### v1.3.6b (2026-04-07)
- Swapped selection colors: yellow for preview, green for active selection

### v1.3.6 (2026-04-06)
- Fixed border thickness visibility synchronization with layer visibility

### v1.3.5 (2026-04-06)
- Fixed corrupted pieces after large group movements
- Improved selection system robustness
